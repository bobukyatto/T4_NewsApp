...
class SignUpViewController: UIViewController {
    ...
    @IBAction func signupTap(_ sender: Any) {
        ...
        if error != nil {
            ...
            // Create the user
            Auth.auth().createUser(withEmail: finalEmail, password: finalPassword) { (result, err) in
    ...
    func showAlert() {
        ...
        let alert = UIAlertController(title: "Welcome to NewsReveal!", message: "You have been successfully registered, please login.", preferredStyle: .alert)
